...
const addDelivery = (req, res) => {
    ...
    const {full_name,delivery_address,company_name,land_mark,mobile,order_no,date} = req.body;
...
//updateResult
  const UpdateDelivery = async (req, res) => {
    ...
    try {
      ...
      const cor = await DeliveryModel.findByIdAndUpdate(DeliveryID, {full_name,delivery_address,company_name,land_mark,mobile,order_no,date});
